/*let number = 5;
console.log('This the value number');
console.log(number);
number = 7;
...
const newNumber = 10;
console.log('This is the new new number');
console.log(number);
newNumber = 12;
...
console.log(printGreeting(`Katrice`));
...
console.log( getTwoLengths(`Grace` , `Mercy`))
console.log( getTwoLengths(`playful` , `greedy`))*/

/*function getMultipleLengths(stringArr){
    const returnArr=[]
    for (let i=0; i< stringArr.length; i++){
       console.log (stringArr[i].length)
returnArr.push(stringArr[i].length)
}
return returnArr
}
console.log(getMultipleLengths(["Stay", "Positive", "it", "will", "come", "tohether"]));*/


/*function threeMax (num1 , num2, num3){

}
let largest = largestThree (num1, num2, num3);
    return largest;  

console.log (largestThree(num1,num2,num3));
console.log(threeMax('6, 9, 1'));
*/
